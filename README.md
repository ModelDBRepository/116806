...
The model can be run online at the [sim.neuroinf.jp simulation platform](http://sim.neuroinf.jp/modules/xoonips/detail.php?item_id=73):
![button](./button.png)
...
[http://creativecommons.org/licenses/by/3.0/](http://creativecommons.org/licenses/by/3.0/) or send a letter to
